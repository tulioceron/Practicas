	...
	document.addEventListener("deviceready", function(){
		...
		$('#Registrar').tap(function(){
			...
			{   var db = window.openDatabase("agenda", "1.0", "Agenda BD", 5000000);
				db.executeSql('CREATE TABLE IF NOT EXISTS reservaciones (id unique, evento, descripcion, fotos, estado)');
				db.executeSql('INSERT INTO reservaciones (evento, descripcion, fotos, estado) VALUES ("'+even+'", "'+desc+'", "'+foto+'", "0")');
			}
